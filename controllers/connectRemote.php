<?php class connect{
    ...
    private $usuario ="id21039245_ferriprog85";   //id21039245_ferriprog85
    private $pass = "Minibus78?"; //Minibus78?
    private $conexion;#objeto de tipo pdo, de la clase propia de php
    private $base = "id21039245_proyectos";  //id21039245_proyectos
   
    public function __construct(){
        // cargar las variables de entorno
        try{
            $this->conexion = new PDO("mysql:host=$this->servidor;dbname=id21039245_proyectos",$this->usuario,$this->pass);
